...
Summary
-------
Test Fashion-MNIST generator.
"""

from znnl.data import FashionMNISTGenerator


class TestFashionMNISTGenerator:
    """
    Class for testing the Fashion-MNIST generator.
    """
    ...
    def test_one_hot_creation(self):
        ...
        """
        generator = FashionMNISTGenerator(ds_size=500)
    ...
    def test_serial_creation(self):
        ...
        Test if one can create the generator.
        """
        generator = FashionMNISTGenerator(ds_size=500, one_hot_encoding=False)
