...
class TestPRNG:
    ...
    def test_deterministic_sequence(self):
        ...
        rng_1 = PRNGKey(42)
        array_1 = jax.random.uniform(key=rng_1(), shape=(100,))

        rng_2 = PRNGKey(42)
        array_2 = jax.random.uniform(key=rng_2(), shape=(100,))
    ...
    def test_random_sequence(self):
        ...
        random_list = []
        for i in range(10):
            random_list.append(jax.random.uniform(key=rng(), shape=(10,)))
    ...
    def test_deterministic_split(self):
        ...
        random_list_1 = []
        for i in range(10):
            random_list_1.append(jax.random.uniform(key=rng_1(), shape=(10,)))

        rng_2 = PRNGKey(42)
        random_list_2 = []
        for i in range(10):
            random_list_2.append(jax.random.uniform(key=rng_2(), shape=(10,)))
